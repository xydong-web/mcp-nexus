...
CREATE TABLE "GrokToolUsage" (
    ...
    "errorMessage" TEXT,
    CONSTRAINT "GrokToolUsage_clientTokenId_fkey" FOREIGN KEY ("clientTokenId") REFERENCES "ClientToken" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "GrokToolUsage_upstreamKeyId_fkey" FOREIGN KEY ("upstreamKeyId") REFERENCES "GrokKey" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
INSERT INTO "new_ClientToken" ("allowedTools", "createdAt", "description", "expiresAt", "id", "rateLimit", "revokedAt", "scopesJson", "tokenEncrypted", "tokenHash", "tokenPrefix") SELECT "allowedTools", "createdAt", "description", "expiresAt", "id", "rateLimit", "revokedAt", "scopesJson", "tokenEncrypted", "tokenHash", "tokenPrefix" FROM "ClientToken";
...
-- CreateIndex
CREATE UNIQUE INDEX "GrokKey_label_key" ON "GrokKey"("label");

-- CreateIndex
CREATE INDEX "GrokKey_status_cooldownUntil_lastUsedAt_idx" ON "GrokKey"("status", "cooldownUntil", "lastUsedAt");

-- CreateIndex
CREATE INDEX "GrokToolUsage_timestamp_idx" ON "GrokToolUsage"("timestamp");

-- CreateIndex
CREATE INDEX "GrokToolUsage_toolName_idx" ON "GrokToolUsage"("toolName");

-- CreateIndex
CREATE INDEX "GrokToolUsage_outcome_idx" ON "GrokToolUsage"("outcome");

-- CreateIndex
CREATE INDEX "GrokToolUsage_clientTokenId_timestamp_idx" ON "GrokToolUsage"("clientTokenId", "timestamp");

-- CreateIndex
CREATE INDEX "GrokToolUsage_queryHash_idx" ON "GrokToolUsage"("queryHash");

-- CreateIndex
CREATE INDEX "GrokToolUsage_upstreamKeyId_idx" ON "GrokToolUsage"("upstreamKeyId");
